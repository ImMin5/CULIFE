...
<style>
	.admin_gallery li:nth-child(1) {
		background: url(/img/admin/3.jpg) no-repeat center center;
	}
</style>
<script>
$(function () {	
...
<div class="admin_container">
	...
	<ul class='adminWarningList'>
		...
		<c:if test="${empty adminWarningList}">
	...
	<c:if test="${pVO.pageNum > 1 }">
		<li class="arrow_next"><a href="/admin/adminWarningList?pageNum=${pVO.pageNum-1}<c:if test='${pVO.searchWord!=null}'>&searchKey=${pVO.searchKey}&searchWord=${pVO.searchWord}</c:if>">&nbsp;&nbsp;&nbsp;</a></li>
	</c:if>
